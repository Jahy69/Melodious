    ...
    <div class="demo-container">
      ...
      <div class="demo-right">
        <div class="description">
          Pour une <span class="bold">utilisation optimale</span> de Melodious,
          posez-lui des <span class="bold">questions ouvertes</span> sur
          différents genres musicaux,
          <span class="bold">explorez ses fonctionnalités</span> pour découvrir
          de nouveaux sens, et demandez-lui des
          <span class="bold">recommandations personnalisées</span>
          pour enrichir votre expérience musicale.
        </div>
      </div>
    </div>
  </div>
...
.send {
  ...
  margin-right: 30px;
  margin-left: 15px;
  background: url("../../public/assets/send.svg");
  background-position: center;
  background-repeat: no-repeat;
  border-style: none;
  cursor: pointer;
